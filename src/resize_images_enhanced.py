...
def positive_int(value):
    ...
    ivalue = int(value)
    if ivalue <= 0:
        raise argparse.ArgumentTypeError("height must be a positive integer")
    return ivalue
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Enhanced image resizer - Scale images to a target pixel height with advanced quality enhancements",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python resize_images_enhanced.py                                 # Interactive mode (default)
  python resize_images_enhanced.py --enhanced                      # Enhanced processing using settings file
  python resize_images_enhanced.py --basic                         # Basic processing
...
Source images are read from 'images/originals' by default.
    ...
    parser.add_argument(
        ...
        type=positive_int,
        default=24,
        help="Target image height in pixels (default: 24)",
    )
...
if __name__ == "__main__":
    ...
    print("Enhanced Image Resizer - Scaling images with quality enhancements")
    print("=" * 80)
    print(f"Target output height: {args.height}px")
